  ...
  const customFooter = useMemo(
    () => (
      <footer className='relative h-auto py-16 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden'>
        ...
        <div className='flex w-full max-w-[1110px] flex-col items-center justify-center gap-6 md:flex-row md:justify-start'>
    ...
    <div className='w-full'>
      {footer ? (
        <footer className='relative h-auto py-4 px-6 md:px-24 w-full flex items-center justify-center overflow-hidden'>
          <div className='flex w-full max-w-[1110px] flex-col items-center justify-center gap-4 md:flex-row md:justify-start'>
            <div
